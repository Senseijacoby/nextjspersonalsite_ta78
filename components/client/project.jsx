...
export default function ClientProjectView({ data }) {
  ...
  return (
    ...
    <div
      className=" mt-24 mb-6 sm:mt-14 sm:mb-14 px-6 sm:px-8 lg:px-16 mx-auto"
      id="project"
    >
      <AnimationWrapper className={"py-6 sm:py-16"}>
        <div className="flex flex-col justify-center items-center md:grid md:grid-cols-2  sm:row-start-1">
